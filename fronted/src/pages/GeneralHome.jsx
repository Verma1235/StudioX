...
import { dev_pic, cemra_pic } from "../img/img";
        ...
        >
          ...
          >
            ...
            <p
              ...
              "
            >
              Luxury wedding and cinematic photography
              experiences crafted with emotions,
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-8 text-white/70 leading-[2]">
                Every wedding is a timeless story.
                Our mission is to create cinematic
                memories filled with emotions,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {[
...

              {
                name: "Emma Watson",
                review:
                  "Luxury experience and breathtaking cinematic quality.",
              },
              ...
              >
                ...
                <p className="text-white/70 leading-[2]">
                  "{item.review}"
                </p>
